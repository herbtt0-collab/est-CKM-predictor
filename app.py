# =========================================================
# 📊 EST Survival Prediction System - Professional Edition
# 专业版生存风险预测系统（适合论文发表）
# 时间单位：年
# =========================================================
...
def main():
    ...
    st.markdown('<h1 class="main-title">🏥 Intelligent Platform for Predicting the Risk of Coronary Heart Disease in CKM Syndrome</h1>',
                unsafe_allow_html=True)
    st.markdown('<p class="sub-title">Extra Survival Trees Model-Based Clinical Decision Support Tool</p>', 
                unsafe_allow_html=True)
    ...
    if demo_mode:
        st.warning("⚠️ **Demo Mode**: Model file not found. Please ensure `est_model.joblib` is in the app directory.")
    ...
    <div class="footer">
        ...
        <p>© 2025 Survival Risk Prediction System | Powered by Extra Survival Trees</p>
    </div>
    """, unsafe_allow_html=True)
